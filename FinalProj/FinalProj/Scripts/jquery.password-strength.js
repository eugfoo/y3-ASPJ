    ...
    $.fn.password_strength = function (options) {
        ...
        return this.each(function () {
            ...
            var container = $('<span></span>')
                .css({ position: 'absolute', top: barTopPos - 6, left: barLeftPos + 30, 'font-size': '75%', display: 'inline-block', width: password_settings.barWidth + 40});
            ...
            .eq(0).css({ height: 3, top: barTopPos - 16, left: barLeftPos + 30, 'border-style': 'solid', 'border-width': 1, padding: 3}).end()
            .eq(1).css({ height: 5, top: barTopPos - 14, left: barLeftPos + 32, padding: 2}).end()
