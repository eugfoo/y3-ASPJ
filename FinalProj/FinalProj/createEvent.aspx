    ...
    <div class="container" id="formContainer">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="box">
                    <asp:Label runat="server" Style="font-size: 28px;">Enter One-Time Password sent to your email</asp:Label>
                    <br />
                    ...
                    <p>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="submit" input="button" runat="server" class="btn btn-success btn-md btn-block" Text="Submit" OnClick="OTPbtn_click" />
