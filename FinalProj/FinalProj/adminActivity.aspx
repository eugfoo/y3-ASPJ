<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBootstrap.Master" AutoEventWireup="true" CodeBehind="adminActivity.aspx.cs" Inherits="FinalProj.WebForm6" %>
                ...
                <div class="row" style="margin-top:1%;">
                    ...
                    <table id="dtBasicExample"  class="table table-striped table-bordered table-sm" cellspacing="0">
                        ...
                        <tbody>
                            <% if (!IsPostBack)
                                {
                                    foreach (var element in admlgList)
                                    { %>
                            <tr>
                            ...
                            <%}
                                ...
                                {
                                    foreach (var element in aadmlgList)
                                    { %>
